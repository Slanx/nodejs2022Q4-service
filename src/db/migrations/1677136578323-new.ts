...
export class new1677136578323 implements MigrationInterface {
  name = 'new1677136578323';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites_artists" ("id" SERIAL NOT NULL, "artistsId" uuid, CONSTRAINT "REL_b1258cf7560cd97b330cf7e923" UNIQUE ("artistsId"), CONSTRAINT "PK_637e68fcd79d90c93a27c66972a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorites_albums" ("id" SERIAL NOT NULL, "albumsId" uuid, CONSTRAINT "REL_efc778ae742551c6b1efd43deb" UNIQUE ("albumsId"), CONSTRAINT "PK_817445cd1f63aebcab5bd55a720" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "favorites_tracks" ("id" SERIAL NOT NULL, "tracksId" uuid, CONSTRAINT "REL_c6f49f60cf32753d164b1d6f3b" UNIQUE ("tracksId"), CONSTRAINT "PK_7a7f123ebc8494fa1c1c013f267" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites_artists" ADD CONSTRAINT "FK_b1258cf7560cd97b330cf7e9231" FOREIGN KEY ("artistsId") REFERENCES "artist"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favorites_albums" ADD CONSTRAINT "FK_efc778ae742551c6b1efd43debb" FOREIGN KEY ("albumsId") REFERENCES "album"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favorites_tracks" ADD CONSTRAINT "FK_c6f49f60cf32753d164b1d6f3b4" FOREIGN KEY ("tracksId") REFERENCES "track"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
